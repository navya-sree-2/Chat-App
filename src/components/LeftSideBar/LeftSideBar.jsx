...
import { collection, doc, getDocs, query, serverTimestamp, setDoc, updateDoc, where, arrayUnion, getDoc } from 'firebase/firestore';
                ...
                {showSearch && user
                    ...
                    (
                        chatData && chatData.length > 0 ? (
                            ...
                            <p className='no-chats'>No chats available</p> // Fallback content
                        ))
                }
            </div>
        </div>
